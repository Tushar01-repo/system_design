...
# please go through this https://www.geeksforgeeks.org/python/multithreading-python-set-1/
...
class BookingService:
    ...
    def lock_seat(self, show_seat_id):
...
#  ----------------------------------- THIS IS PHASE 2 IMPLEMENTATION FOR RACE CONDITION -----------------------------------
...
class Screen:
    ...
    def add_seats(self, seat):
        # BASICALLY WE ARE ADDING COMPLETE OBJECT
        self.seats.append(seat)
...
if __name__ == "__main__":
    ...
    def try_booking(user):
        ...
        try:
            ...
            # HERE USER AND SHOW ARE COMPLETE OBJECT
